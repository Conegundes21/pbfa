  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 pt-20">
        <div className="max-w-5xl mx-auto text-center">
          <motion.div
            ...
            className="mb-6"
          >
            <div className="inline-block px-3 py-1 rounded-full bg-nature-green/10 border border-nature-green/20 text-nature-green text-sm font-medium mb-6">
          ...
          >
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-nature-green-light to-nature-blue animate-text-gradient">
          ...
          >
            <Button className="bg-nature-green hover:bg-nature-green-dark text-white px-8 py-6 rounded-md text-lg shadow-lg hover:shadow-glow transition-all duration-300 flex items-center gap-2 w-full sm:w-auto group">
              Nossos Serviços
              <motion.span
            ...
            <Button
              variant="outline"
              className="border border-white/20 text-white hover:bg-white/5 px-8 py-6 rounded-md text-lg w-full sm:w-auto transition-all duration-300"
            >
              Agendar Consultoria
            </Button>
          </motion.div>
      ...
      >
        ...
        >
          <ChevronDown className="h-10 w-10 text-nature-green" />
        </motion.div>
      </motion.div>
    </section>
  );
