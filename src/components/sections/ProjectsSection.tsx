    ...
    <section id="projects" className="py-24 bg-dark-100">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-7xl mx-auto">
              ...
              <TabsList className="flex flex-wrap justify-center gap-3 mb-12 bg-transparent">
                {categories.map((category) => (
                  <TabsTrigger
                    ...
                    className="px-5 py-2.5 border border-dark-400 rounded-md data-[state=active]:bg-nature-green data-[state=active]:text-white data-[state=active]:border-nature-green text-gray-300 font-medium transition-all duration-300 hover:border-nature-green/50"
                  >
                    {category.label}
                  </TabsTrigger>
                ))}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {filteredProjects.map((project, index) => (
                  <motion.div
                    ...
                    className="group"
                  >
                    <div className="bg-dark-200 rounded-xl overflow-hidden border border-dark-400 hover:border-nature-green/20 transition-all duration-300 h-full shadow-dark hover:shadow-glow-lg hover:shadow-nature-green/10">
                      <div className="relative">
                        <div className="flex">
                          ...
                          <div className="w-1/2 relative overflow-hidden">
                            <div className="absolute top-3 right-3 bg-nature-green text-white text-xs px-3 py-1.5 rounded-md z-10 font-semibold">
                              Depois
                            </div>
                            <img
                      ...
                      <div className="p-6">
                        <h4 className="text-xl font-bold mb-3 text-white group-hover:text-nature-green transition-colors duration-300">
                          {project.title}
                        </h4>
                        ...
                        <div className="grid grid-cols-3 gap-3 mb-6">
                          {project.metrics.map((metric, idx) => (
                            <div
                              key={idx}
                              className="bg-dark p-4 rounded-lg text-center border border-dark-400 group-hover:border-nature-green/20 transition-all duration-300"
                            >
                              <p className="text-gray-400 text-xs mb-1">
                                {metric.label}
                              </p>
                              <p className="text-nature-green font-bold">
                                {metric.value}
                              </p>
                            </div>
                          ))}
                        ...
                        <div className="flex items-center text-nature-green font-medium text-sm group-hover:text-nature-green-light transition-colors duration-300">
          ...
          >
            <Button className="bg-nature-green hover:bg-nature-green-dark text-white px-8 py-6 rounded-md text-lg shadow-lg hover:shadow-glow transition-all duration-300 group">
